...
@Component({
  ...
  template: `
    <section class="section-hero bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900 text-white relative overflow-hidden">
      ...
      <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-20">
          ...
          <div class="text-center lg:text-left space-y-8 animate-fade-in-left">
            <div class="space-y-4">
              <h1 class="text-5xl sm:text-6xl lg:text-7xl font-display font-bold leading-tight">
                Meet
                <span class="text-gradient block">swbox</span>
              </h1>
              <p class="text-xl sm:text-2xl text-gray-300 font-light max-w-2xl">
                The most advanced Summoners War Discord bot designed for competitive RTA players
              </p>
            </div>
          ...
          <div class="relative animate-fade-in-right">
            ...
            <!-- Glow effect -->
            <div class="absolute inset-0 bg-gradient-to-r from-primary-500/20 to-secondary-500/20 rounded-3xl blur-3xl animate-glow"></div>
          </div>
        </div>
      </div>
