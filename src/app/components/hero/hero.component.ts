    ...
    template: `
        ...
        >
            ...
            <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div
                    class="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-20"
                >
                    <!-- Content -->
                    <div
                        class="text-center lg:text-left space-y-8 animate-fade-in-left"
                    >
                        <div class="space-y-4">
                            <h1
                            ...
                            <p
                                class="text-xl sm:text-2xl text-gray-300 font-light max-w-2xl"
                            >
                                The most advanced Summoners War Discord bot
                                designed for competitive RTA players
                            </p>
                        </div>

                        <div class="space-y-6">
                            <p class="text-lg text-gray-400 max-w-xl">
                                Access realtime player statistics, monster
                                analytics, leaderboard tracking, and strategic
                                insights to dominate the Real Time Arena.
                            </p>
                        ...
                        <!-- Stats -->
                        <div
                            class="grid grid-cols-3 gap-8 pt-8 border-t border-gray-700"
                        >
                    ...
                    <div class="relative animate-fade-in-right">
                        <div class="relative z-10 animate-float">
                            ...
                            >
                                <mat-icon class="text-secondary-400"
...
export class HeroComponent implements OnInit, OnDestroy {
    ...
    private async fetchUniqueUsersCount(): Promise<void> {
        try {
            ...
            if (!Number.isNaN(nb)) {
                const activeStat = this.stats.find(
                    (s) => s.label === "Active users"
                );
                if (activeStat) {
