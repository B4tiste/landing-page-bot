...
@Component({
  ...
  template: `
    <section class="section bg-gradient-to-r from-primary-900 via-secondary-900 to-primary-900 text-white relative overflow-hidden">
      <!-- Background Pattern -->
      <div class="absolute inset-0 opacity-10">
        <div class="absolute inset-0" style="background-image: radial-gradient(circle at 25% 25%, #0ea5e9 0%, transparent 50%), radial-gradient(circle at 75% 75%, #d946ef 0%, transparent 50%);"></div>
      </div>
      ...
      <div class="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="animate-scale-in">
          ...
          <p class="text-xl sm:text-2xl text-gray-200 mb-12 max-w-3xl mx-auto leading-relaxed">
            Join thousands of competitive players who trust swbox for their Summoners War analytics and strategic insights.
          </p>
        </div>

        <!-- CTA Buttons -->
        <div class="flex flex-col sm:flex-row gap-6 justify-center mb-16 animate-fade-in-up">
          <a 
        ...
        <!-- Trust Indicators -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 animate-fade-in-up" style="animation-delay: 0.3s;">
        ...
        <div class="animate-fade-in-up" style="animation-delay: 0.6s;">
          <p class="text-gray-300 mb-8">Trusted by competitive guilds and top RTA players worldwide</p>
